...
async function createInitialUsers() {
  ...
  try {
    ...
    const usersToCreate = [
      ...
      { username: 'Admin', password: 'Admin123', email: 'admin.support@ByteMarket.com' },
    ]
...
async function createProducts() {
  try {
    ...
    const productsToCreate = [
      ...
      { name: 'ASUS Gaming Setup', description: 'Omen 30L RTX 3060 Ryzen 5, iPad 11" M1, Roccat gaming keyboard, one 60hz vertical and one 165hz omen horizontal monitors. Perfect out of the box ready to handle all your gaming needs!', price: '3600', imgUrl: 'https://i.imgur.com/pRcIuSZ.jpeg', category: 'setup' },
